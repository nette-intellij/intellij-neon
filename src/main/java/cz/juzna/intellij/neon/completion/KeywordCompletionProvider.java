...
public class KeywordCompletionProvider extends CompletionProvider<CompletionParameters> {
	...
	public KeywordCompletionProvider() {
		...
		knownKeysPattern.put("di|export", new String[]{"parameters", "tags", "types"});
		...
		knownKeysPattern.put("http|csp", cspKeys);
		knownKeysPattern.put("http|cspReportOnly", cspKeys);

		knownKeysPattern.put("http|featurePolicy", new String[]{"autoplay", "camera", "encrypted-media", "fullscreen", "geolocation", "microphone", "midi", "payment", "vr"});
