...
public class NeonSyntaxHighlighter extends SyntaxHighlighterBase {
	...
	public static final TextAttributesKey PARAMETER_USAGE = TextAttributesKey.createTextAttributesKey("ParameterUsage", DefaultLanguageHighlighterColors.DOC_COMMENT);
	...
	public static final TokenSet sClassName = TokenSet.create(NEON_CLASS_NAME);
